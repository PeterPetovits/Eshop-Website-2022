window.onload=function(){
    ...
    let url_str = "https://wiki-shop.onrender.com/categories/?id"
    let url = new URL(url_str);
    let search_params = url.searchParams;


    if(search_params.get('id')==0){
         fetch("https://wiki-shop.onrender.com/categories/:0/products",init)
